"use client" // client side rendering needed due to the React Hooks being used
...
const Nav = () => {
   ...
   // const isUserLoggedIn = false; // mocking a signed in and signed out status for testing
      ...
      <nav className="flex-between w-full mb-16 pt-3">
         ...
         <div className="sm:flex hidden">
            {session?.user ? (
               ...
               <>
                  {/* {console.log("provider 2", providers)} */}
                  {providers &&
         ...
         <div className="sm:hidden flex relative">
            {session?.user ? (
               <div className="flex">
                  <Image src="/assets/images/profile.svg" width={37} height={37} className="rounded-full" alt="profile"
                     onClick={() => {
                        setToggleDropdown((prev) => !prev) // kinda like doing setToggleDropdown(!toggleDropdown)
                     }} />
